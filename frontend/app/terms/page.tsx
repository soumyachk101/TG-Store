      ...
      <main className="relative z-10 flex-1 w-full max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-ink-muted leading-relaxed">
          <section className="bg-bg-raised/20 border border-line p-6 rounded-2xl">
            ...
            <p>
              By deploying, accessing, or using TGStore (&quot;the Service&quot;), you agree to comply with and be bound by these Terms & Conditions. If you do not agree, please do not use the application. TGStore is designed as a self-hosted cloud storage tool leveraging the Telegram network for file CDN storage.
            </p>
          </section>

          <section className="bg-bg-raised/20 border border-line p-6 rounded-2xl">
            <h2 className="text-base font-semibold text-ink mb-3">2. Description of Service</h2>
            <p>
              TGStore is an open-source platform that enables users to upload files, which are chunked, uploaded to Telegram channels via Telegram&apos;s Bot API, and indexed in a local database. You acknowledge that TGStore does not provide the underlying storage itself; it relies entirely on the API, infrastructure, and terms of Telegram FZ-LLC.
            </p>
          </section>

          <section className="bg-bg-raised/20 border border-line p-6 rounded-2xl">
            <h2 className="text-base font-semibold text-ink mb-3">3. Account Responsibility</h2>
            <p>
              You are responsible for securing your database credentials, API parameters, and Telegram Bot tokens. You agree to immediately notify the developer or take security measures if you detect any unauthorized access to your account or deployment.
            </p>
          </section>

          <section className="bg-bg-raised/20 border border-line p-6 rounded-2xl">
            <h2 className="text-base font-semibold text-ink mb-3">4. Acceptable Use Policy</h2>
            <p>
              You agree not to use TGStore to store, distribute, or transmit any files that:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1.5 text-xs">
              <li>Infringe upon intellectual property, patent, trademark, or copyrights of third parties.</li>
              <li>Contain viruses, trojan horses, worms, or other malicious code designed to disrupt standard systems.</li>
              <li>Violate the official Telegram Terms of Service or local laws in your jurisdiction.</li>
            </ul>
          </section>
          ...
          <section className="bg-bg-raised/20 border border-line p-6 rounded-2xl">
            ...
            <p>
              THE SERVICE IS PROVIDED &quot;AS IS&quot; WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED. The developer (Soumya Chakraborty) makes no guarantees regarding the uptime, data persistence, safety, or reliability of storing files using Telegram as a backend CDN. Use at your own risk.
            </p>
          </section>
        </div>
      </main>
